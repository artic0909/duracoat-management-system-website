...
class ViewerController extends Controller
{
    ...
    public function totalPendingMaterials()
    {
        ...
        return view('viewer.total_pending_materials', compact('jobcards'));
    }
    ...
    public function nineTankTestingView(Request $request)
    {
        ...
        return view('viewer.ninetank-testing', compact('records'));
    }

    public function nineTankTestingPrint($id)
    {
        $record = NineTankTest::findOrFail($id);
        return view('viewer.ninetank-testing-print', compact('record'));
    }

    // 3 Tank Testings ======================================>
    public function threeTankTestingView()
    {
        return view('viewer.threetank-testing');
    }
}

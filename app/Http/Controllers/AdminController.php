...
class AdminController extends Controller
{
    ...
    public function dashboardView()
    {
        ...
        return view('admin.dashboard', compact('sumofquantity', 'lowstock', 'restock', 'totalClients', 'totalOrders', 'totalJobcards', 'totalDeliveries', 'totalTests'));
    }
    ...
    public function paintManageView(Request $request)
    {
        ...
        return view('admin.paint-manage', compact('paints'));
    }
    ...
    public function clientManageView(Request $request)
    {
        ...
        return view('admin.material-manage', compact('paints', 'clients'));
    }
    ...
    public function orderCreateView(Request $request)
    {
        ...
        return view('admin.order-create', compact('clients', 'orders', 'jobcardsCountPerticularOrder'));
    }
    ...
    public function addJobcardView($order_id)
    {
        try {
            ...
            return view('admin.add-jobcard', compact('order', 'clientMaterials'));
        } catch (\Exception $e) {
    ...
    public function addJobcardStore(Request $request, $order_id)
    {
        try {
            ...
            return redirect()->route('admin.view-created-jobcards', $order->id)->with('success', 'Jobcard created successfully!');
        } catch (\Exception $e) {
    ...
    public function editJobcardView($id)
    {
        ...
        return view('admin.edit-jobcard', compact('jobcard', 'clientMaterials'));
    }
    ...
    public function updateJobcard(Request $request, $id)
    {
        ...
        return redirect()
            ->route('admin.view-created-jobcards', $jobcard->order_id)
    ...
    public function viewCreatedJobcards($order_id)
    {
        ...
        return view('admin.view-jobcard-details', compact('order', 'jobcards'));
    }
    ...
    public function jobcardTestsView($id)
    {
        ...
        return view('admin.jobcard-test', compact('jobcard', 'existingTest'));
    }
    ...
    public function jobcardTestStoreAndEdit(Request $request, $id)
    {
        ...
        return redirect()->route('admin.view-created-jobcards', $jobcard->order_id)
    ...
    public function materialOutView(Request $request)
    {
        ...
        return view('admin.material-out', compact('jobcards'));
    }
    ...
    public function stockManageView(Request $request)
    {
        ...
        return view('admin.stock-manage', compact('paints'));
    }

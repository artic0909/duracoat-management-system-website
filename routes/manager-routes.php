...
Route::middleware(['auth:manager'])->prefix('manager')->group(function () {
    ...
    Route::get('/total-powder-applied', [ManagerController::class, 'totalPowderApplied'])->name('manager.total-powder-applied');
    Route::get('/total-pending-materials/export', [ManagerController::class, 'exportPendingMaterials'])->name('manager.total-pending-materials.export');
    Route::get('/total-pretreatment-done/export', [ManagerController::class, 'exportPretreatmentDone'])->name('manager.total-pretreatment-done.export');
    Route::get('/total-powder-applied/export', [ManagerController::class, 'exportPowderApplied'])->name('manager.total-powder-applied.export');

        ...
        <div class="container-fluid py-1 px-3">
            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                    <form action="{{ route('admin.material-out') }}" method="GET"
                        ...
                        <a href="{{ route('admin.material-out') }}" class="btn btn-secondary"
                            style="padding: 6px 15px; border-radius: 5px;">Reset</a>

                        <a href="{{ route('admin.export.client.out') }}" class="btn"
            ...
            <div class="modal-dialog modal-xl">
                <form class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="{{ route('admin.jobcard.pdf', $jobcard->id) }}" class="btn btn-success">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <textarea name="delivery_statement" id="delivery_statement_{{ $jobcard->id }}" rows="4"
                                class="form-control"
                                placeholder="Write your delivery note or reason...">{{$jobcard->delivery_statement}}</textarea>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                                Close

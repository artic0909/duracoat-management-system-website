    ...
    <div class="row mt-2">
        <div class="col-md-4 mb-4">
            <div class="action-card pending position-relative">
                <div style="text-align: left !important;">
                    ...
                    <a href="{{ route('admin.total-pending-materials.export') }}" class="btn btn-sm btn-outline-warning mt-2 mb-0 position-relative" style="z-index: 2;">Export</a>
                </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="action-card pretreat position-relative">
                <div style="text-align: left !important;">
                    ...
                    <a href="{{ route('admin.total-pretreatment-done.export') }}" class="btn btn-sm btn-outline-info mt-2 mb-0 position-relative" style="z-index: 2;">Export</a>
                </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="action-card powder-applied position-relative">
                <div style="text-align: left !important;">
                    <a href="{{ route('admin.total-powder-applied') }}" class="stretched-link"></a>
                    ...
                    <a href="{{ route('admin.total-powder-applied.export') }}" class="btn btn-sm btn-outline-success mt-2 mb-0 position-relative" style="z-index: 2;">Export</a>
                </div>

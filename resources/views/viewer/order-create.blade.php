    ...
    <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                <form action="{{ route('viewer.orders-and-jobcards') }}" method="GET" style="display: flex; gap: 10px; align-items: center; margin-bottom: 15px;">
                    ...
                    <a href="{{ route('viewer.orders-and-jobcards') }}" class="btn btn-secondary"
                        style="padding: 6px 15px; border-radius: 5px;">Reset</a>

                    <a href="{{ route('viewer.export.orders') }}" class="btn"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-sm">{{ $order->created_at->format('d-m-Y h:i A') }}</h6>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <div class="d-flex gap-2 justify-content-center">
                                            <!-- <a href="{{ route('viewer.add-jobcards', ['order_id' => $order->id] )}}"
                                                class="btn btn-primary px-3 py-2 rounded m-0">
                                                <i class="fa fa-plus"></i> Add Jobcard
                                            </a> -->

                                            <a href="{{ route('viewer.view-created-jobcards', $order->id) }}"
...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form class="modal-content" method="POST" action="{{ route('viewer.orders-and-jobcards.store') }}">
            @csrf
...
<div class="modal fade" id="editModal{{ $order->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $order->id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form action="{{ route('viewer.orders-and-jobcards.update', $order->id) }}" method="POST" class="modal-content">
            @csrf
            @method('PUT')
...
<div class="modal fade" id="deleteModal{{$order->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form class="modal-content" action="{{ route('viewer.orders-and-jobcards.delete', $order->id) }}" method="POST">
            @csrf
            @method('DELETE')

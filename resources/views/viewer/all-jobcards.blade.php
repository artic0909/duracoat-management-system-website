    ...
    <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                <form action="{{ route('viewer.all-jobcards') }}" method="GET" style="display: flex; gap: 10px; align-items: center; margin-bottom: 15px;">
                    ...
                    <a href="{{ route('viewer.all-jobcards') }}" class="btn btn-secondary"
                        style="padding: 6px 15px; border-radius: 5px;">Reset</a>

                    <a href="{{ route('viewer.export.jobcards') }}" class="btn"
                        ...
                        <table class="table align-items-center mb-0">
                                ...
                                <tr>
                                    ...
                                    <td class="text-start text-xs font-weight-bold">
                                        <div class="d-flex gap-2 flex-column">
                                            ...
                                            <a href="{{ route('viewer.jobcard-test', $jobcard->id) }}"
                                            ...
                                            <a href="{{ route('viewer.jobcard.view', $jobcard->id) }}" target="_blank"
                                                class="btn btn-info px-3 py-2 rounded m-0">
                                                <i class="fas fa-eye"></i> View
                                            </a>
                                            <a href="{{ route('viewer.jobcard.pdf', $jobcard->id) }}"
                                            ...
                                            @else
                                            <div>
                                                <a href="{{ route('viewer.edit-jobcards', $jobcard->id) }}" class="btn btn-info rounded m-0">
                            ...
                            <div class="modal fade" id="pretreatmentModal{{ $jobcard->id }}" tabindex="-1" aria-labelledby="pretreatmentLabel{{ $jobcard->id }}" aria-hidden="true">
                                <div class="modal-dialog">
                                    <form action="{{ route('viewer.update.pretreatment', $jobcard->id) }}" method="POST">
                                        @csrf
                            ...
                            <div class="modal fade" id="powderappliedModal{{ $jobcard->id }}" tabindex="-1" aria-labelledby="powderappliedLabel{{ $jobcard->id }}" aria-hidden="true">
                                <div class="modal-dialog">
                                    <form action="{{ route('viewer.update.powderapplied', $jobcard->id) }}" method="POST">
                                        @csrf
                                        <div class="modal-content">
                                            <div class="modal-header">
...
<div class="modal fade" id="deleteModal{{ $jobcard->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form class="modal-content" action="{{ route('viewer.add-jobcards.delete', $jobcard->id) }}" method="POST">
            @csrf
            @method('DELETE')
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <form class="modal-content shadow-lg border-0 rounded-3">
            ...
            <div class="modal-footer">
                ...
                <a href="{{ route('viewer.jobcard-test.download', $jobcard->id) }}" class="btn btn-warning">

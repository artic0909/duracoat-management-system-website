        ...
        <div class="col-md-12">
            <div class="card shadow-sm border-0 rounded-3">
                ...
                <div class="card-body p-4">
                    <form id="updateProfileForm" action="{{ route('viewer.profile.update') }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" class="form-control" id="profileName"
                                    value="{{ Auth::guard('viewer')->user()->name }}" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control" id="profileEmail"
                                    value="{{ Auth::guard('viewer')->user()->email }}" readonly>
                            </div>
                        </div>

...
@section('content')
        ...
        <div class="container-fluid py-1 px-3">
            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                    <form method="GET" action="{{ route('viewer.stocks-manage') }}"
    ...
    <!-- Add Stock Modal -->
    @foreach ($paints as $paint)
        <div class="modal fade" id="addstockModal{{$paint->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <form class="modal-content" action="{{ route('viewer.stocks-manage.update', $paint->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <input type="number" name="quantity" class="form-control" placeholder="Enter quantity in KG"
                                    required>

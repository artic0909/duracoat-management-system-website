    ...
    <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                ...
                <form method="GET" action="{{ route('manager.used-paints') }}"
                    ...
                    <div style="display: flex; align-items: center; justify-content: center; gap: 5px;">
                        <input type="text" name="search"
                            placeholder="Search by RAL code"
                    ...
                    <a href="{{ route('manager.used-paints') }}"
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-xs font-weight-bold mb-0">{{ \Carbon\Carbon::parse($paint->last_updated_at ?? $paint->last_created_at)->format('d-m-Y') }}</p>
                                    </td>
                                    <td>
                                    ...
                                    <td class="align-middle text-center">
                                        <span class="text-secondary text-xs font-weight-bold" style="text-transform: capitalize;">{{$paint->paint->shade_name}}</span>
                                    </td>
                                    <td class="align-middle text-center">
                                        <span class="text-secondary text-xs font-weight-bold" style="text-transform: capitalize;">{{$paint->paint->finish}}</span>
                                    </td>
                                    <td class="align-middle text-center">
                                        <span class="badge badge-sm bg-primary">{{ number_format($paint->total_used_paint, 2) }} KG</span>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="9" class="text-center">
                                        <div class="d-flex justify-content-center align-items-center gap-3 mt-3">
                                            ...
                                            @else
                                            <a href="{{ $usedPaints->previousPageUrl() }}" class="text-primary text-decoration-none">Prev</a>
                                            @endif

                                            <span>{{ $usedPaints->currentPage() }} / {{ $usedPaints->lastPage() }}</span>

                                            @if ($usedPaints->hasMorePages())
                                            <a href="{{ $usedPaints->nextPageUrl() }}" class="text-primary text-decoration-none">Next</a>
                                            @else

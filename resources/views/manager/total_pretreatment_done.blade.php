...
@section('title', 'Total Pretreatment Done')
                                                            ...
                                                            <div class="modal-body text-start">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <p class="mb-1"><strong>Status:</strong> <span class="badge bg-info">{{ ucfirst($jobcard->jobcard_status) }}</span></p>
                                                                        <p class="mb-1"><strong>Pre-treatment Date:</strong> {{ $jobcard->pre_treatment_date ? \Carbon\Carbon::parse($jobcard->pre_treatment_date)->format('d-m-Y') : 'N/A' }}</p>

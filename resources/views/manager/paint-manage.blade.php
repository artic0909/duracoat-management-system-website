...
@section('content')
                ...
                <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                    <form method="GET" action="{{ route('manager.paint-manage') }}"
                        ...
                        <div style="display: flex; align-items: center; justify-content: center; gap: 5px;">
                            <input type="text" name="search" placeholder="Search by RAL or Paint ID"
                        ...
                        <select name="stock_status" onchange="this.form.submit()"
                            ...
                            <option value="low" {{ request('stock_status') == 'low' ? 'selected' : '' }}>Low Stock (≤ 5)
                            </option>
                                                ...
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">
                                                            {{ ($paints->currentPage() - 1) * $paints->perPage() + $loop->iteration }}
                                                        </h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{$paint->created_at->format('d-m-Y')}}
                                                </p>
                                            </td>
                                            <td>
    ...
    <!-- Edit Modal -->
    @foreach($paints as $paint)
        <div class="modal fade" id="editModal{{$paint->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="paintName">Paint Name/ Ral Code</label>
                                    <input type="text" name="ral_code" value="{{$paint->ral_code}}" class="form-control"
                                        id="paintName" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="brandName">Brand Name</label>
                                    <input type="text" name="brand_name" value="{{$paint->brand_name}}" class="form-control"
                                        id="brandName" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="shadeName">Shade Name</label>
                                    <input type="text" class="form-control" value="{{$paint->shade_name}}" name="shade_name"
                                        id="shadeName" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="quantity">Purchase Quantity</label>
                                    <input type="text" class="form-control" value="{{$paint->quantity}}" name="quantity"
                                        id="quantity" />
                                </div>
                            </div>
                        </div>
    ...
    <!-- Delete Modal -->
    @foreach($paints as $paint)
        <div class="modal fade" id="deleteModal{{$paint->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">

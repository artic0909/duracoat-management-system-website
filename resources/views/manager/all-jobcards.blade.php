    ...
    <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                <form action="{{ route('manager.all-jobcards') }}" method="GET" style="display: flex; gap: 10px; align-items: center; margin-bottom: 15px;">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-xs font-weight-bold">
                                        <div class="d-flex gap-2 flex-column">
                                            ...
                                            @else
                                            <div>
                                                <a href="{{ route('manager.edit-jobcards', $jobcard->id) }}" class="btn btn-info rounded m-0">
...
<div class="modal fade" id="deleteModal{{ $jobcard->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form class="modal-content" action="{{ route('manager.add-jobcards.delete', $jobcard->id) }}" method="POST">
            @csrf
            @method('DELETE')

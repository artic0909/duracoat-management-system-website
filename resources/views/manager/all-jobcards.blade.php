                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        ...
                                        <button type="button" class="btn btn-success px-3 py-2 rounded m-0"
                                            data-bs-toggle="modal" data-bs-target="#pretreatModal">
                                    ...
                                    <td class="align-middle text-center">
                                        ...
                                        <br>
                                        <button type="button" class="btn btn-success px-3 py-2 rounded m-0"
                                            data-bs-toggle="modal" data-bs-target="#powderappliedModal">
                                            <i class="fa fa-check"></i>
                                        </button>
                                    </td>
                                    <td class="align-middle text-center">
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <div class="d-flex gap-2 flex-column">
                                            ...
                                            <div>
                                                <a href="edit-jobcard.html" class="btn btn-info rounded m-0">

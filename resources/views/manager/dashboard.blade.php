...
<style>
    ...
    /* Gradient Variants */
    .gradient-blue { background: linear-gradient(120deg, #4facfe 0%, #00f2fe 100%); }
    .gradient-purple { background: linear-gradient(120deg, #a18cd1 0%, #fbc2eb 100%); } /* Generic */
    .gradient-orange { background: linear-gradient(120deg, #f6d365 0%, #fda085 100%); }
    .gradient-red { background: linear-gradient(120deg, #ff9a9e 0%, #fecfef 99%, #fecfef 100%); background: linear-gradient(to right, #ff416c, #ff4b2b); }
    .gradient-deep-blue { background: linear-gradient(to right, #434343 0%, black 100%); } /* Dark mode feel */
    .gradient-royal { background: linear-gradient(to right, #141e30, #243b55); } 

    .bg-main-stats { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); }
    .bg-warn-stats { background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); }
    .bg-danger-stats { background: linear-gradient(135deg, #fa709a 0%, #fee140 100%); background: linear-gradient(to right, #ed213a, #93291e); }
    ...
    .bg-light-yellow { background-color: #fff3cd; color: #ffc107; }
    .bg-light-info { background-color: #cff4fc; color: #0dcaf0; }
    ...
    .op-icon-primary { background: rgba(5, 117, 230, 0.1); color: #0575e6; }
    .op-icon-success { background: rgba(0, 176, 155, 0.1); color: #00b09b; }
    .op-icon-warning { background: rgba(255, 195, 113, 0.1); color: #ff5f6d; }
    .op-icon-dark    { background: rgba(52, 71, 103, 0.1); color: #344767; }
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="hero-card bg-main-stats">
                ...
                <div class="hero-card-content">
                    ...
                    <div class="hero-value">{{ $sumofquantity}} <span style="font-size: 1rem; opacity:0.8;">KG</span></div>
                </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="action-card pending position-relative">
                <div style="text-align: left !important;">
                    ...
                    <a href="{{ route('manager.total-pending-materials.export') }}" class="btn btn-sm btn-outline-warning mt-2 mb-0 position-relative" style="z-index: 2;">Export</a>
                </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="action-card pretreat position-relative">
                <div style="text-align: left !important;">
                    ...
                    <a href="{{ route('manager.total-pretreatment-done.export') }}" class="btn btn-sm btn-outline-info mt-2 mb-0 position-relative" style="z-index: 2;">Export</a>
                </div>
